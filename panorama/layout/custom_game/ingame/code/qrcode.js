...
Game.ShowQRCode = function(data, container, width){
	CreateQRCode(data, container, width)
}
...
(()=>{
	// CreateQRCode("https://github.com/XavierCHN/panorama-qrcode", $("#erweimaContainer"),500) 
})();